...
namespace CourseManagementAPI.Migrations
{
    ...
    [Migration("20260401224036_AddRefreshTokens")]
            ...
            modelBuilder.Entity("CourseManagementAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 4, 1, 22, 40, 36, 134, DateTimeKind.Utc).AddTicks(1042),
                            Email = "admin@coursemanagement.com",
                            PasswordHash = "$2a$11$mQiD1iKlXjo2dc4P.1.Acuq50mlRXaF9X3VYo4XgFoX/jh7Pq6XT.",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
